...
public class FoodManagerFragment extends BaseFragment {
    ...
    private void createFragments(){
        ...
        mFragments.add(GoodsFragment.newInstance(DataUrl.YINGER_SHIPIN));
        mFragments.add(GoodsFragment.newInstance(DataUrl.JINKOU_SHIPIN));
        mFragments.add(GoodsFragment.newInstance(DataUrl.XIANGCHUN_JIUSHUI));
        mFragments.add(GoodsFragment.newInstance(DataUrl.PINPAI_MINGCHA));
        mFragments.add(GoodsFragment.newInstance(DataUrl.JIANKANG_YINLIAO));
        mFragments.add(GoodsFragment.newInstance(DataUrl.LIANGYOU_GANHUO));
    }
