 ...
 * Time: 10:58
 */
public class ForenoticeAdapter extends DataBaseAdapter<Forenotice>{
    public ForenoticeAdapter(Context context, List<Forenotice> list) {
        super(context, list);
    }
    ...
    public View createView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.sold.setText(mList.get(position).getIs_onsale());
        return convertView;
    }
