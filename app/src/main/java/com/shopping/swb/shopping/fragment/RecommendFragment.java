...
import com.shopping.swb.shopping.adapter.RecommendAdapter;
import com.shopping.swb.shopping.entity.Recommend;
import com.shopping.swb.shopping.entity.RecommendList;
...
public class RecommendFragment extends BaseFragment implements PullToRefreshBase.OnRefreshListener2
    ...
    private List<Recommend> mGoodsList = new ArrayList<>();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mGoodsAdapter = new RecommendAdapter(mActivity, mGoodsList);
    ...
    private void initGoods(String json) {
        try {
            RecommendList goodsList = Utility.getData(json, RecommendList.class);
            mGoodsList.clear();
...
//        }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        intent.putExtra("origin_price", mGoodsList.get(position).getO_price());
        intent.putExtra("now_price", mGoodsList.get(position).getN_price());
