...
import com.shopping.swb.shopping.adapter.ForenoticeAdapter;
import com.shopping.swb.shopping.entity.Forenotice;
import com.shopping.swb.shopping.entity.ForenoticeList;
...
public class ForenoticeFragment extends BaseFragment implements PullToRefreshBase.OnRefreshListener2
    ...
    private List<Forenotice> mGoodsList = new ArrayList<>();
    private ForenoticeAdapter mGoodsAdapter;
    private CircularProgressBar mProgressBar;
    private ImageView mImageView;
    private FloatingActionButton mActionButton;
    private int mFirstVisibleItem = 0;

    public static ForenoticeFragment newInstance(String url) {
        ForenoticeFragment fragment = new ForenoticeFragment();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mGoodsAdapter = new ForenoticeAdapter(mActivity, mGoodsList);
    ...
    private void initGoods(String json) {
        try {
            ForenoticeList goodsList = Utility.getData(json, ForenoticeList.class);
            mGoodsList.clear();
...
//        }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        intent.putExtra("sold", mGoodsList.get(position).getIs_onsale());
